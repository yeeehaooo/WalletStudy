...
namespace WalletLibrary.GoogleWallet.Flight.Interfaces
{
    ...
    public interface IFlightObjectRepository
    {
        ...
        Task<Google.Apis.Walletobjects.v1.Data.FlightObject> GetAsync(string resourceId);
        ...
        Task<Google.Apis.Walletobjects.v1.Data.FlightObject> InsertAsync(Google.Apis.Walletobjects.v1.Data.FlightObject entity);
        ...
        Task<Google.Apis.Walletobjects.v1.Data.FlightObject> UpdateAsync(Google.Apis.Walletobjects.v1.Data.FlightObject entity);
        ...
        Task<Google.Apis.Walletobjects.v1.Data.FlightObject> PatchAsync(Google.Apis.Walletobjects.v1.Data.FlightObject entity);
        ...
        Task<Google.Apis.Walletobjects.v1.Data.FlightObject> AddMessageAsync(AddMessageRequest addMessageRequest, string resourceId);
