...
namespace WalletLibrary.GoogleWallet.WalletTypes.Flight.Interfaces
{
    ...
    public interface IFlightObjectRepository
    {
        ...
        Task<FlightObject> GetAsync(string resourceId);
        ...
        Task<FlightObject> InsertAsync(FlightObject entity);
        ...
        Task<FlightObject> UpdateAsync(FlightObject entity);
        ...
        Task<FlightObject> PatchAsync(FlightObject entity);
        ...
        Task<FlightObject> AddMessageAsync(AddMessageRequest addMessageRequest, string resourceId);
        ...
        /// <param name="resourceId">資源唯一識別碼（格式通常為 issuerId.objectId）。</param>
        /// <returns>對應的資源類別物件。</returns>
        Task<FlightObject> ExpireObjectAsync(string resourceId);
        ...
        Task<FlightObject> UpdateObjectStatusAsync(string resourceId, string objectState);
    }
}
