...
namespace WalletLibrary.GoogleLibrary.Base.Interfaces
{
    ...
    public interface IClassResource<TClass>
    {
        ...
        Task<TClass> GetAsync(string resourceId);
        ...
        Task<TClass> InsertAsync(TClass entity);
        ...
        Task<TClass> PatchAsync(TClass entity);
        ...
        Task<TClass> AddMessageAsync(AddMessageRequest addMessageRequest, string resourceId);
    }
}
